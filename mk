...
if [ $SYS = "Linux" ]; then
    DEFS=NVLinux
    LIBRARIES="-L $PFM_LIB -lgsf -lCZMIL -lCHARTS -lnvutility -llas -lgdal -lxml2 -lpoppler -lproj -lGLU"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="WIN32 NVWIN3X UINT32_C INT32_C"
    LIBRARIES="-L $PFM_LIB -lgsf -lCZMIL -lCHARTS -lnvutility -llas -lgdal -lxml2 -lpoppler -lproj -liconv"
